...
| `30.项目管理` | `/project-management/` | 基础框架、预测型方法、敏捷与混合型方法、PMP认证备考 |
...
04.PMP认证备考/
  00.概览.md
  01.PMP三十记总览与知识地图.md
  02.PMP过程域：从方法选择到项目收尾.md
  03.PMP人员域：团队领导与干系人协作.md
  04.PMP商业环境域：治理、价值、合规与组织变革.md
  05.PMP预测型、敏捷与混合型场景决策指南.md
  06.PMP冲刺资料68道练习题：考点索引与解析.md
```
