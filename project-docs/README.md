...
| 内容规模 | 46 个 Markdown，其中 30 篇普通文章，其余为首页、目录页和知识索引 |
| 静态构建结果 | 47 个 HTML、5,204 个站内引用，构建检查通过 |
...
- `main` 和 `gh-pages` 已于 2026-07-27 完成上一轮受控推送与发布。
- 当前工作树已完成内容目录精简与敏捷方法指南迁移，并通过完整构建验证；提交与发布需另行执行。
- 本轮未执行百度推送或 npm 包发布。
